...
import { faUsers, faMoneyCheckAlt, faArrowRight, faRupeeSign } from '@fortawesome/free-solid-svg-icons'
...
function ExpenditureInfo(props) {
  ...
  function handleSubmit(event) {
    ...
    if (info.title === '' && info.peopleNames === '' &&
      ...
      // window.friend = { currency: currencies.filter(c => c === info.currency)[0] }
      if (props.onSubmitSucceeded) {
      ...
      <Form noValidate
        ...
        <Form.Group controlId="group-members">
          ...
          <Form.Control required
                        name="peopleNames"
                        type="text"
                        placeholder="Nimit, Nitin, Ojaswit"
        ...
        <Form.Group controlId="currency">
          <Form.Label><FontAwesomeIcon icon={faRupeeSign} /> Select the currency</Form.Label>
          <br/>
